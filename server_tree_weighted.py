...
from utils import visualize_frequency, weight_score
...
class FAServer(FAServerPEM):
    ...
    def predict_heavy_hitters(self) -> Dict:
        ...
        for i in range(self.batch_size):
            ...
            clients_participating = [234, 234, 234, 234, 234, 234, 234, 234, 234, 234, 234, 234, 234, 234, 234, 234]

            varepsilons = [1.8 for i in range(self.batch_size)] 
